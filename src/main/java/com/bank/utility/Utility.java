...
//***************************** Is Display Methods **********************************************//
    ...
    public void verifyAssertText(WebElement element,String message){
        String expectedmessage = message;
        SoftAssert softAssert =new SoftAssert();
        String actualmessage = getTextFromElement(element);
      //  Assert.assertEquals(actualmessage,expectedmessage,message + "  It is not display");
        softAssert.assertEquals(actualmessage,expectedmessage,message + "  It is not display");
